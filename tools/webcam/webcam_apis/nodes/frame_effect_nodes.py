...
from mmpose.core import apply_bugeye_effect, apply_sunglasses_effect, apply_firecracker_effect
...
def _get_wrist_keypoint_ids(model_cfg: Config) -> Tuple[int, int]:
    ...
    try:
        ...
        right_wrist_idx = dataset_info.keypoint_name2id.get('right_wrist', None)
    except AttributeError:
        left_wrist_idx = None
