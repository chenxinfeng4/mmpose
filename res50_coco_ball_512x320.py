# tools/dist_train.sh res50_coco_ball_512x320.py 4
# python tools/train.py res50_coco_ball_512x320.py
# python -m lilab.mmpose_dev.a2_convert_mmpose2onnx res50_coco_ball_512x320.py
_base_ = [
    'configs/_base_/default_runtime.py',
    'configs/_base_/datasets/coco_caliball.py'
]

# load_from = 'work_dirs/res50_coco_ball_512x320/latest.pth'
    ...
    train=dict(
        ...
        datasets=[
            dict(
                ...
                ann_file='data/ball/ball_train.json',
            ...
            dict(
                type='TopDownCocoDatasetTight',
                ann_file='data/ball/ballextra_trainval.json',
                img_prefix='data/ball/images/',
                data_cfg=data_cfg,
                pipeline=train_pipeline,
                dataset_info={{_base_.dataset_info}}),
