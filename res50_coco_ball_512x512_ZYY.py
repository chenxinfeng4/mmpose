# tools/dist_train.sh res50_coco_ball_512x512_ZYY.py 4
# python tools/train.py res50_coco_ball_512x512_ZYY.py
_base_ = [
    'configs/_base_/default_runtime.py',
    'configs/_base_/datasets/coco_caliball.py'
]

load_from = 'work_dirs/res50_coco_ball_512x512_ZYY/latest.pth'
total_epochs = 180
...
train_pipeline = [
    ...
    dict(type='TopDownGenerateTarget', sigma=6),  #sigma=2
    dict(
        type='Collect',
...
data = dict(
    ...
    train=dict(
        ...
        datasets=[
            ...
            dict(
                type='TopDownCocoDatasetTight',
                ann_file=
                'data/ball/ball_2448x2048x9_20230707_marmoset_train.json',
                img_prefix='data/ball/ball_2448x2048x9_20230707_marmoset/',
                data_cfg=data_cfg,
                pipeline=train_pipeline,
                dataset_info={{_base_.dataset_info}}),
            dict(
                type='TopDownCocoDatasetTight',
                ann_file=
                'data/ball/ball_2448x2048x9_20230814_marmoset_train.json',
                img_prefix='data/ball/ball_2448x2048x9_20230814_marmoset/',
                data_cfg=data_cfg,
                pipeline=train_pipeline,
                dataset_info={{_base_.dataset_info}}),
            dict(
    ...
    val=dict(
        type='TopDownCocoDatasetTight',
        ann_file='data/ball/ball_2448x2048x9_20230814_marmoset_val.json',
        img_prefix='data/ball/ball_2448x2048x9_20230814_marmoset/',
        data_cfg=data_cfg,
